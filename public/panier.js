...
pool.getConnection()
    .then(conn => {
        ...
        conn.query("INSERT INTO `client` (`id_client`, `nom_client`, `prenom_client`, `mail_client`, `CP_client`, `adresse_client`, `ville_client`, `pays_client`) VALUES ('6', 'test', 'test', 'test', '04100', 'test', 'test', 'test'); ");
    })
